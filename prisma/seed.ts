...
const PRODUCTS = [
  ...
  { id: "prod_047", sellerId: "seller_005", name: "Café Honduras Copán SHG", description: "Granos de altura de Copán, proceso lavado. Notas de melocotón, miel y almendra tostada. Acidez suave y cuerpo equilibrado.", categories: ["café"], price: 4400, stock: 35, unit: "250G / GRANO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-Honduras-coffee-beans.png?v=1767842964", location: "Honduras", isLimitedEdition: false },
  { id: "prod_048", sellerId: "seller_005", name: "Café Brasil Cerrado Natural", description: "Proceso natural del Cerrado minero. Bajo en acidez, notas de chocolate amargo, avellana y caramelo. Clásico y muy equilibrado.", categories: ["café"], price: 3200, stock: 55, unit: "500G / MOLIDO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-Brazil-santos-medium-roast-coffee-cocoa-notes-coffee-beans.png?v=1767842864", location: "Minas Gerais, Brasil", isLimitedEdition: false },
  { id: "prod_049", sellerId: "seller_005", name: "Café Guatemala Huehuetenango", description: "De los Cuchumatanes, proceso lavado. Notas de ciruela madura, chocolate y flores blancas. Acidez viva, cuerpo medio-alto.", categories: ["café"], price: 5600, stock: 25, unit: "250G / GRANO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-Guatemala-bourbon-barrel-coffee.png?v=1767886451", location: "Guatemala", isLimitedEdition: false },
  { id: "prod_050", sellerId: "seller_005", name: "Café Costa Rica Honey Tarrazu", description: "Proceso miel de la Zona de Los Santos. Dulzor natural de panela, cuerpo cremoso y acidez suave. Perfecto para espresso suave.", categories: ["café"], price: 6800, stock: 18, unit: "200G / GRANO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-Costa-Rica-medium-roast-sweet-apple-honey-coffee-beans.png?v=1767841986", location: "Costa Rica", isLimitedEdition: false },
  { id: "prod_051", sellerId: "seller_005", name: "Café Descafeinado Swiss Water", description: "Proceso Swiss Water 100% libre de solventes. Preserva el perfil sensorial del origen colombiano. Sin cafeína, ideal para la tarde.", categories: ["café"], price: 4900, stock: 30, unit: "250G / MOLIDO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-Colombian-medellin-medium-roast-orange-chocolate-coffee-beans.png?v=1767842292", location: "Colombia", isLimitedEdition: false },
  { id: "prod_052", sellerId: "seller_005", name: "Café Nicaragua SHG Maracaturra", description: "Varietal Maracaturra de grano grande del norte de Nicaragua. Natural, notas de fruta tropical, caramelo y cacao oscuro.", categories: ["café"], price: 4200, stock: 40, unit: "250G / GRANO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-nicaraguan-coffee-beans.png?v=1767841736", location: "Nicaragua", isLimitedEdition: false },
  { id: "prod_053", sellerId: "seller_005", name: "Café Rwanda Bourbon Lavado", description: "Bourbon rojo de Nyungwe, fermentación larga 72 hs. Notas de grosella, ciruela pasa y té negro. Acidez elegante y persistente.", categories: ["café"], price: 5800, stock: 22, unit: "250G / GRANO", imageUrl: "https://beanswithoutborders.com/cdn/shop/files/No-text-African-espresso-blend-ethiopian-kenyan-tanzanian-sweet-cocoa-beans.png?v=1767892275", location: "Rwanda", isLimitedEdition: false },
