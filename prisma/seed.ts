...
const PRODUCTS = [
  ...
  { id: "prod_034", sellerId: "seller_002", name: "Gift Box Premium Infusio", description: "Caja regalo curada: mate artesanal, bombilla de alpaca, 3 variedades de yerba y mezcla de tés seleccionada. El regalo perfecto.", categories: ["mates", "accesorios", "combos"], price: 12000, stock: 10, unit: "SET COMPLETO", imageUrl: null, location: "Buenos Aires, Argentina", isLimitedEdition: true, badge: "LOTE ESPECIAL" },
